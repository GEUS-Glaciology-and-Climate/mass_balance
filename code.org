...
for RCM in ['mean', 'HIRHAM', 'MAR']:
    SMB['SMB_' + RCM] = (('time'),
              np.append(k2015['SMB_'+RCM].values/365, SMB['SMB_'+RCM].sel({'time':slice('1986','2200')}).values))
    SMB['SMB_'+RCM+'_err'] = (('time'),
                  np.append(k2015['SMB_'+RCM+'_err'].values/365, SMB['SMB_'+RCM+'_err'].sel({'time':slice('1986','2200')}).values))
...
for roi in ['sector', 'region']: # TODO: 'basin'
    ...
    for RCM in ['mean', 'HIRHAM', 'MAR']:
        MB_hist = (k2015['SMB_'+RCM] - k2015['D'] - k2015['BMB'])/365
    ...
    MB['SMB_HIRHAM'] = (('time'), SMB['SMB_HIRHAM_err'].data)
    MB['SMB_MAR'] = (('time'), SMB['SMB_MAR'].data)
    MB['SMB_MAR'] = (('time'), SMB['SMB_MAR_err'].data)
