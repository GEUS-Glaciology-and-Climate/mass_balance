...
c1 = 61 # Last column
r0 = 30 # sub-table start
r1 = 37 # sub-table stop
M =  pd.DataFrame(index = df.iloc[r0:r1][df.columns[1]],
                  data = df.iloc[r0:r1][df.columns[c0:(c1 + 1)]].values,
                  columns = df.iloc[r0-1][df.columns[c0:(c1 + 1)]].astype(np.int)).T
M.index = pd.to_datetime(M.index, format='%Y')
M.index.name = "Date"
M

c2  = 82
c3 = 128
M_err =  pd.DataFrame(index = df.iloc[r0:r1][df.columns[1]],
                      data = df.iloc[r0:r1][df.columns[c2:(c3 + 1)]].values,
                      columns = df.iloc[r0-1][df.columns[c2:(c3 + 1)]]).T
# M_err.index = pd.to_datetime(M_err.index, format='%Y')
M_err.index = M.index
M_err.index.name = "Date"
# M_err
#+END_SRC
...
|---------------------+---------+---------+---------+---------+---------+---------+---------|
| 1972-01-01 00:00:00 | 18.1084 | 17.7086 | 15.4343 | 6.48401 | 8.21288 | 24.0786 | 25.7445 |
| 1973-01-01 00:00:00 | 18.1084 | 16.1314 | 14.2655 | 6.08707 | 7.94735 | 22.2909 | 24.0785 |
| 1974-01-01 00:00:00 | 18.1063 | 14.7527 |  13.147 | 5.76098 | 7.81424 | 20.6225 | 22.5849 |
| 1975-01-01 00:00:00 | 18.0951 | 13.6102 | 12.1232 | 5.54693 | 7.71855 | 19.0735 |  21.255 |
| 1976-01-01 00:00:00 | 18.0852 | 12.8103 | 11.2326 | 5.42609 | 7.74586 | 17.6567 | 20.0771 |
| 1977-01-01 00:00:00 | 18.0767 | 12.2711 | 10.4528 | 5.35282 | 7.92991 | 16.3691 | 19.0572 |
| 1978-01-01 00:00:00 | 17.9698 | 11.9116 | 9.78121 | 5.32584 | 8.09695 | 15.2108 | 18.1123 |
| 1979-01-01 00:00:00 | 17.4074 | 11.7076 | 9.21818 | 5.34529 | 8.29683 | 14.1904 | 16.9734 |
| 1980-01-01 00:00:00 | 16.7838 |  11.659 | 8.77116 | 5.40104 | 8.55599 |  13.312 | 15.6209 |
| 1981-01-01 00:00:00 | 16.2156 | 11.3925 | 8.29304 | 5.22144 | 8.40569 | 12.5795 | 14.4042 |
| 1982-01-01 00:00:00 |  15.678 | 10.8492 | 7.80831 | 5.07294 |  8.1252 |  12.004 | 13.3214 |
| 1983-01-01 00:00:00 | 15.1968 | 10.4345 | 7.42044 | 4.96149 |  7.8905 | 11.5744 | 12.3762 |
| 1984-01-01 00:00:00 | 14.7683 | 10.1345 | 7.13732 |  4.8902 | 8.78129 | 11.2813 |  11.604 |
| 1985-01-01 00:00:00 | 14.3943 | 9.58564 | 6.99548 | 4.78036 | 8.33391 | 11.1605 | 11.0613 |
| 1986-01-01 00:00:00 | 14.0689 | 9.56755 | 6.89744 | 4.77232 | 8.04398 | 8.63489 | 10.7258 |
| 1987-01-01 00:00:00 | 13.7879 | 9.68934 | 6.92356 | 4.74902 | 7.72023 | 8.72705 |  10.524 |
| 1988-01-01 00:00:00 | 13.5516 |  9.5621 |  6.9054 | 4.75884 | 7.60389 | 8.51424 | 10.6101 |
| 2012-01-01 00:00:00 | 13.4056 | 11.0662 | 7.07223 | 4.82103 | 7.41863 | 10.4209 | 10.8736 |
| 2013-01-01 00:00:00 | 13.3455 | 11.1711 | 7.04389 | 4.88826 | 7.36562 | 10.1806 | 10.6097 |
| 2014-01-01 00:00:00 | 13.1909 | 11.2452 | 7.12058 | 4.94795 | 7.41319 | 10.0416 |  10.592 |
| 2015-01-01 00:00:00 | 13.2549 | 11.1447 | 7.13684 |  4.8762 | 7.44949 | 9.88694 |  10.647 |
| 2016-01-01 00:00:00 | 13.2423 | 11.0883 | 7.12681 | 4.82375 | 7.46161 |  9.7747 | 10.5025 |
| 2017-01-01 00:00:00 | 13.1144 |  10.452 | 7.28769 | 4.81795 | 7.46435 | 9.82613 | 10.4776 |
| 2018-01-01 00:00:00 | 13.1735 | 10.2604 | 7.38047 | 4.86793 | 7.54204 | 10.1958 |  10.548 |
...
# Mouginot
<<load_mouginot>>
M = M.sum(axis='columns').cumsum()
M_err = M_err.sum(axis='columns').cumsum()
M.plot(ax=ax, color='g', label='Mouginot(2019)')
ax.fill_between(M.index, M - M_err, M + M_err, color='g', alpha=0.25)


# IMBIE
<<load_imbie>>
imbie['mb_cum'] = imbie['mb_cum'] - 400 # offset
imbie['mb_cum'].plot(ax=ax, color='r', label='IMBIE')
...
sec_sum = sec_sum - 300
sec_sum.plot(ax=ax, color='cyan', label='SEC')
...
gmb_sum.plot(ax=ax, color='k', label='GRACE')
...
promice_sum["MB"].plot(ax=ax, color='purple', label='Colgan (2019)')
...
axCB.set_yticklabels([1995,2015])

plt.savefig('tmp/colgan_2019.png', transparent=False, bbox_inches='tight', dpi=300)
#+END_SRC

#+RESULTS:
: <ipython-input-958-66f0de76b6e0>:180: UserWarning: This figure includes Axes that are not compatible with tight_layout, so results might be incorrect.
:   plt.savefig('tmp/colgan_2019.png', transparent=False, bbox_inches='tight', dpi=300)

** INPROGRESS This vs. Mouginot (2019): GIS
...
# PROMICE MB (Colgan 2019)
<<load_mouginot>>
M = M.sum(axis="columns")
M_err = M_err.sum(axis="columns")
#+END_SRC
...
# plt.close(1)
fig = plt.figure(1, figsize=(6,10.5)) # w,h
# get_current_fig_manager().window.move(0,0)
fig.clf()
fig.set_tight_layout(True)
...
#for ds in [promice, this_smb, this_D, this_mb]:
...
def my_plot(ax, x, y):
    ax.scatter(x.values, y.values, alpha=0.1)
    yr = [_[2:4] for _ in x.time.dt.year.values.astype(np.str)]
    for i,s in enumerate(yr):
        ax.text(x.values[i], y.values[i], s,
                fontsize=8,
                horizontalalignment='center', verticalalignment='center')

    mmin = np.min([ax.get_xlim()[0], ax.get_ylim()[0]])
    mmax = np.max([ax.get_xlim()[1], ax.get_ylim()[1]])
    ax.set_xlim(mmin, mmax); ax.set_ylim(mmin, mmax)
    ax.plot([mmin, mmax], [mmin, mmax], color='k', alpha=0.25, linestyle='--')
    adj(ax, ['left','bottom'])
    ...
    if x.sector.values == 8:
        if ax == axSMB: ax.set_xlabel('SMB')
        if ax == axD: ax.set_xlabel('D')
        if ax == axMB: ax.set_xlabel('MB')
