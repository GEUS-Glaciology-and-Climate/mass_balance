...
** Twitter figure TMB
:PROPERTIES:
:header-args:python+: :tangle twitfig_tmb.py
:END:
...
:PROPERTIES:
:header-args:python+: :tangle twitfig_sermeq_kujalleq.py
:END:
...
:PROPERTIES:
:header-args:python+: :tangle twitfig_sermeq_kujalleq_2000_present.py
:END:
