...
box['smb_err'] = (box['mb_err']**2 + box['mmb_err']**2)**0.5
...
#+RESULTS:
: <ipython-input-147-7154e2525c1e>:145: UserWarning: This figure includes Axes that are not compatible with tight_layout, so results might be incorrect.
:   plt.savefig('tmp/mouginot_2019.png', transparent=False, bbox_inches='tight', dpi=300)
...
#+RESULTS:
: <ipython-input-18-8e7cc1a3456f>:151: UserWarning: This figure includes Axes that are not compatible with tight_layout, so results might be incorrect.
:   plt.savefig('tmp/colgan_2019.png', transparent=False, bbox_inches='tight', dpi=300)
