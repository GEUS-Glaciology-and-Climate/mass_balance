...
#+BEGIN_SRC bash
g.region w=-13.65 e=1.3 s=-9.8 n=12.2 -pa res=0:03
g.region w=w-0.025 e=e+0.025 s=s-0.025 n=n+0.025 -pa
g.region save=RCM
...
<<get_DATADIR>>
ds = xr.open_dataset("/home/kdm/data/MAR/daily/MARv3.11-20km-daily-NCEP-NCARv1-2000.nc")
...
g.region e=$E w=$W s=$S n=$N -pal res=20000
g.region save=RCM
