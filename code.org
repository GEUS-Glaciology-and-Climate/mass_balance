...
** Twitter figure TMB
:PROPERTIES:
:header-args:jupyter-python+: :tangle twitfig_tmb.py
:END:
...
df = pd.read_csv('/home/shl/data/promice/TMB/MB_SMB_D_BMB.csv', index_col=0, parse_dates=True)
...
:PROPERTIES:
:header-args:jupyter-python+: :tangle twitfig_sermeq_kujalleq.py
:END:
...
:PROPERTIES:
:header-args:jupyter-python+: :tangle twitfig_sermeq_kujalleq_2000_present.py
:END:
