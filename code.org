...
# for f in ${dir}/MAR-????*.nc; do ## initial
for f in $(ls ${dir}/MAR-????.nc | tail -n2); do ## operational
  dates=$(python ./nc_dates.py ${f})
...
| mean  | -87.3525 | 127.982 | 367.107 |  90.783 | 430.229 | 78.6821 | 24.2307 | 13.0278 |
| std   |  117.116 | 21.1847 | 99.7624 | 31.7356 | 32.4704 | 16.2356 | 1.69217 | 3.82393 |
| min   | -436.092 | 53.8557 | 85.7866 |  7.7208 | 301.549 | 32.1532 | 15.3884 | 3.44985 |
| 25%   |  -168.08 |  125.41 | 301.155 | 94.5937 | 407.617 | 79.4034 | 23.2301 | 13.9843 |
| 50%   |  -74.916 | 136.026 | 376.011 | 104.156 | 428.706 | 85.2135 | 24.2423 | 14.6838 |
| 75%   | -4.73222 | 140.923 | 432.959 | 109.691 | 449.048 | 88.1928 | 25.1732 | 15.1436 |
| max   |  130.697 | 155.513 | 578.715 | 123.009 | 501.049 | 99.0497 | 30.1038 | 16.6656 |
...
bmb         21.795260
bmb_err     13.771214
Name: 1846-01-01 00:00:00, dtype: float64
#+end_example
...
| mean  | -1.49682 |  -0.456367 | -2.00035 | -0.515628 | -0.466029 | -0.282566 | -0.0374954 |   -0.057849 |
| std   |  97.4918 |    6.63317 |  96.4435 |   7.66439 |    15.995 |   2.68875 |    1.55361 |    0.665697 |
| min   | -340.548 |   -37.2035 | -338.518 |  -39.7246 |  -197.651 |  -22.7762 |   -8.83719 |    -5.09502 |
| 25%   | -59.7093 |   -3.15345 | -58.4066 |  -3.63217 |  -3.25074 | -0.953041 |  -0.674775 |    -0.23635 |
| 50%   | -8.02914 | -0.0462173 | -6.39214 | -0.143827 |  0.709816 | 0.0644973 | 0.00336225 | -0.00328227 |
| 75%   |   60.848 |    2.82951 |  58.1801 |   3.09637 |   4.34169 |  0.932861 |   0.622575 |    0.231408 |
| max   |  347.018 |    17.8351 |   342.25 |   30.8025 |   19.9101 |   3.76593 |    5.85415 |    0.952317 |
...
#+begin_example
time
1840-01-01    -17.722289
1850-01-01    -37.550131
1860-01-01     43.444240
1870-01-01    -20.059455
1880-01-01    -11.082348
1890-01-01    -17.447604
1900-01-01   -128.324427
1910-01-01    -41.767090
1920-01-01   -135.526880
1930-01-01   -210.524530
1940-01-01    -94.380772
1950-01-01   -141.587325
1960-01-01   -176.679917
1970-01-01    -14.565464
1980-01-01    -39.354854
1990-01-01    -72.056727
2000-01-01   -182.398597
2010-01-01   -257.496914
2020-01-01   -173.670187
Freq: 10AS-JAN, Name: mb, dtype: float64
#+end_example
|       |        mb |   mb_err |      smb |   smb_err |      mmb |   mmb_err |      bmb |   bmb_err |
|-------+-----------+----------+----------+-----------+----------+-----------+----------+-----------|
| count |   19      |  19      |  19      |   19      |  19      |   19      | 19       |  19       |
| mean  |  -90.9869 | 125.644  | 362.029  |   87.8947 | 428.972  |   77.1284 | 24.0444  |  12.6705  |
| std   |   83.302  |  23.1444 |  61.9468 |   33.7014 |  29.8369 |   17.3885 |  1.55013 |   4.06309 |
| min   | -257.497  |  72.4574 | 246.511  |   22.186  | 379.117  |   41.7827 | 19.807   |   4.544   |
| 25%   | -157.629  | 117.791  | 313.756  |   83.0851 | 407.702  |   74.0688 | 23.4152  |  12.3504  |
| 50%   |  -72.0567 | 136.212  | 385.63   |  103.765  | 423.683  |   85.4904 | 24.178   |  14.6821  |
| 75%   |  -18.8909 | 140.625  | 409.869  |  108.762  | 446.272  |   87.3668 | 25.0474  |  15.1326  |
| max   |   43.4442 | 149.124  | 444.943  |  115.906  | 493.614  |   96.3241 | 26.5152  |  15.9145  |
:END:
...
mb        -17.447604
mb_err    140.033177
Name: 1890-01-01 00:00:00, dtype: float64
...
| mean  |    1.03124 |  0.290488 |   1.15637 |  0.236577 |     26.5062 |     20.4862 |
| std   |   0.324278 | 0.0235757 | 0.0715717 | 0.0129634 |     62.9035 |    0.884237 |
| min   | -0.0478229 |  0.235289 |  0.988269 |  0.204409 |    -709.634 |      18.703 |
| 25%   |   0.813983 |  0.273394 |   1.11124 |   0.22782 |     22.5413 |      19.799 |
| 50%   |    1.04712 |  0.289019 |   1.14707 |  0.235848 |     27.7321 |     20.5599 |
| 75%   |    1.22838 |  0.304232 |    1.2001 |  0.244505 |     35.0467 |     21.1155 |
| max   |    1.82311 |  0.347791 |   1.32424 |  0.270985 |     99.1524 |     22.0924 |
...
r.mapcalc "BedMachine = if(mask@VHD, 1, null())" --o
...
#+RESULTS[(2021-07-30 08:23:56) fd0bc7d2d15eb3b0eef2fbdb6e1db6b319506fea]:
#+begin_example
+-----------------------------------------------------------------------------+
|                      Category Information                        |  square  |
|description                                                     |kilometers|
...
|1|MAR                                                             | 1,756,400|
| |----------------------------------------------------------------|----------|
| |1|BedMachine . . . . . . . . . . . . . . . . . . . . . . . . . .| 1,754,000|
| |*|no data. . . . . . . . . . . . . . . . . . . . . . . . . . . .|      2400|
|------------------------------------------------------------------|----------|
|*|no data                                                         | 2,378,000|
| |----------------------------------------------------------------|----------|
| |1|BedMachine . . . . . . . . . . . . . . . . . . . . . . . . . .|   499,600|
| |*|no data. . . . . . . . . . . . . . . . . . . . . . . . . . . .| 1,878,400|
|-----------------------------------------------------------------------------|
|TOTAL                                                             | 4,134,400|
+-----------------------------------------------------------------------------+
...
GRASS 7.8.2 (G_MAR):~/projects/total_mass_balance > +-----------------------------------------------------------------------------+
|                      Category Information                        |  square  |
|description                                                     |kilometers|
|-----------------------------------------------------------------------------|
|1|BedMachine                                                      | 2,253,600|
| |----------------------------------------------------------------|----------|
| |1|MAR. . . . . . . . . . . . . . . . . . . . . . . . . . . . . .| 1,754,000|
| |*|no data. . . . . . . . . . . . . . . . . . . . . . . . . . . .|   499,600|
|------------------------------------------------------------------|----------|
...
r.univar -g map=RU_2020 zones=MAR | grep sum # 1114065
r.univar -g map=RU_2020 zones=BedMachine | grep sum # 1099213
#+END_SRC
...
#+RESULTS[(2021-07-30 08:29:05) f4030c2ff71f4076318c6c2b9e23f344733420d7]: MAR_BedMachine
| Year |              MAR |       BedMachine |
| 2010 | 4109.90460243548 | 4059.44226327265 |
| 2011 | 3114.77885228729 | 3075.31025487518 |
| 2012 | 4875.94117719235 | 4827.41576367917 |
| 2013 | 2277.12132363507 | 2247.17856579014 |
| 2014 | 3057.85905723095 | 3016.70468859196 |
| 2015 | 2757.52450856081 | 2721.84771331659 |
| 2016 | 3603.89943862867 | 3562.28780771207 |
| 2017 |  2590.9033618991 | 2550.35681257888 |
| 2018 | 2163.02035407689 | 2132.39001183179 |
| 2019 | 4312.17310972402 | 4265.50459928701 |
...
Year                                            
2010  0.004110    0.004059 -1.227823  101.243086
2011  0.003115    0.003075 -1.267140  101.283402
2012  0.004876    0.004827 -0.995201  101.005205
2013  0.002277    0.002247 -1.314939  101.332460
2014  0.003058    0.003017 -1.345856  101.364216
2015  0.002758    0.002722 -1.293798  101.310756
2016  0.003604    0.003562 -1.154628  101.168115
2017  0.002591    0.002550 -1.564958  101.589838
2018  0.002163    0.002132 -1.416091  101.436432
2019  0.004312    0.004266 -1.082250  101.094091
             MAR  BedMachine        BM%        MAR%
count  10.000000   10.000000  10.000000   10.000000
mean    0.003286    0.003246  -1.266268  101.282760
std     0.000912    0.000906   0.164116    0.168375
min     0.002163    0.002132  -1.564958  101.005205
25%     0.002633    0.002593  -1.338126  101.186858
50%     0.003086    0.003046  -1.280469  101.297079
75%     0.003983    0.003935  -1.172927  101.356277
max     0.004876    0.004827  -0.995201  101.589838
#+end_example
...
#+NAME: tbl_credit
| Task                   | KDM | XF | PL | MS | KK | NBK | BN | MvdB | WC | SS | JB | AS | MDK | APA | SBA | RSF |
...
|------------------------+-----+----+----+----+----+-----+----+------+----+----+----+----+-----+-----+-----+-----|
| #ERROR                 |  33 | 19 | 19 | 11 | 14 |  14 | 14 |   12 | 10 |  8 | 10 | 13 |   7 |   8 |   5 |  10 |
#+TBLFM: @>=vsum(@2..@-1)
...
wget -a ~/data/MAR/wget.log -np -nc ftp://ftp.climato.be/fettweis/tmp/ken/MAR-202*.nc
mv MAR-202*.nc ../3.12
#+END_SRC
