...
for roi in ['sector', 'region']: # TODO: 'basin'
    ...
    MB.attrs['acknowledgment'] = 'Ken Mankoff created the original workflow for PROMICE'
    # MB.attrs['license'] = 'TODO'
    # MB.attrs['date_created'] = datetime.datetime.now().strftime('%Y-%m-%d')
    MB.attrs['creator_name'] = 'PROMICE: Signe H. Larsen'
    MB.attrs['creator_url'] = 'https://promice.org/'
    MB.attrs['creator_email'] = 'shl@geus.dk'
    MB.attrs['institution'] = 'GEUS'
    MB.attrs['publisher'] = 'GEUS'
    MB.attrs["publisher_url"] = "https://www.geus.dk/"
