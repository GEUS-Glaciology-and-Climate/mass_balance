...
\author[1]{\url{https://docs.google.com/spreadsheets/d/1tK3_IjpTSBbbw5cgW3vTZMKTsgwss6FF207QXAxlZ-4/edit#gid=0}
%\Author[2]{Brice}{Noël}
...
GRACE is only "operational"

GRACE as standard but suffers from
+ Low spatial resolution
+ Does not distinguish between processes (SMB and BMB v. dynamics)

SEC is high spatial resolution, becoming "operational", but also does not distinguish processes.

Only IO can separate processes, use multiple RCMs, and is now operational.
