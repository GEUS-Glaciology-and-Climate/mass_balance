...
The method for scaling discharge from runoff was introduced by citet:rignot_2008_mass who scaled SMB anomaly with discharge. citet:box_2013_III isolated runoff as the more effective discharge predictor after a sensitivity analysis. While the fitting sample includes the recent anomalous period of discharge 2000 through 2005, the sample also includes years 1958 and 1964 that lie near the regression line (see citet:box_2013_III Fig. 4 and related Sect. 4 "Physical basis"). TODO Furthermore, while 2000 through 2006 cover a changing period in Greenland discharge, there were likely other 'anomalous' periods in the past. There is independent evidence that the 1920s or 1940s may have been periods of significant discharge increase.
